...
const CANVAS_PRESETS: CanvasPaletteItem[] = [
  ...
  { id: 'server', label: '服务器', description: '后端服务图标', icon: 'mdi:server-outline', iconAsset: 'server', color: '#0f766e', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'client', label: '客户端', description: '桌面或网页图标', icon: 'mdi:monitor-dashboard', iconAsset: 'client', color: '#7c3aed', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'browser', label: '浏览器', description: '浏览器图标', icon: 'mdi:web', iconAsset: 'browser', color: '#2563eb', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'mobile', label: '移动端', description: '手机图标', icon: 'mdi:cellphone', iconAsset: 'mobile', color: '#2563eb', group: 'architecture', variant: 'icon', width: 34, height: 46, minWidth: 24, minHeight: 34 },
  { id: 'gateway', label: '网关', description: '访问入口图标', icon: 'mdi:api', iconAsset: 'gateway', color: '#ea580c', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'apiIcon', label: 'API', description: '接口服务图标', icon: 'mdi:api', iconAsset: 'api', color: '#2563eb', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'cloud', label: '云服务', description: '云资源图标', icon: 'mdi:cloud-outline', iconAsset: 'cloud', color: '#0284c7', group: 'architecture', variant: 'icon', width: 46, height: 34, minWidth: 32, minHeight: 24 },
  { id: 'databaseIcon', label: '数据库', description: '数据库图标', icon: 'mdi:database-outline', iconAsset: 'database', color: '#0891b2', group: 'architecture', variant: 'icon', width: 44, height: 44, minWidth: 30, minHeight: 30 },
  { id: 'folderIcon', label: '文件夹', description: '文件夹图标', icon: 'mdi:folder-outline', iconAsset: 'folder', color: '#ca8a04', group: 'architecture', variant: 'icon', width: 44, height: 44, minWidth: 30, minHeight: 30 },
  { id: 'bucketIcon', label: '存储桶', description: '对象存储图标', icon: 'mdi:bucket-outline', iconAsset: 'bucket', color: '#0f766e', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'searchIcon', label: '搜索', description: '搜索图标', icon: 'mdi:magnify', iconAsset: 'search', color: '#0284c7', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'userIcon', label: '用户', description: '用户图标', icon: 'mdi:account-outline', iconAsset: 'user', color: '#9333ea', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'usersIcon', label: '用户组', description: '多用户图标', icon: 'mdi:account-group-outline', iconAsset: 'users', color: '#9333ea', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'shieldIcon', label: '安全', description: '安全图标', icon: 'mdi:shield-check-outline', iconAsset: 'shield', color: '#16a34a', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'lockIcon', label: '权限', description: '锁图标', icon: 'mdi:lock-outline', iconAsset: 'lock', color: '#16a34a', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  ...
  { id: 'queue', label: '队列', description: '异步通道图标', icon: 'mdi:transit-connection-variant', iconAsset: 'queue', color: '#9333ea', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'chartIcon', label: '图表', description: '指标图标', icon: 'mdi:chart-box-outline', iconAsset: 'chart', color: '#dc2626', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'uploadIcon', label: '上传', description: '上传流向图标', icon: 'mdi:upload-outline', iconAsset: 'upload', color: '#0d9488', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'downloadIcon', label: '下载', description: '下载流向图标', icon: 'mdi:download-outline', iconAsset: 'download', color: '#0284c7', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'mailIcon', label: '消息', description: '消息通知图标', icon: 'mdi:email-outline', iconAsset: 'mail', color: '#ea580c', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'terminalIcon', label: '终端', description: '命令行图标', icon: 'mdi:console', iconAsset: 'terminal', color: '#475569', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'globeIcon', label: '网络', description: '全球网络图标', icon: 'mdi:web', iconAsset: 'globe', color: '#0284c7', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'settingsIcon', label: '配置', description: '配置图标', icon: 'mdi:cog-outline', iconAsset: 'settings', color: '#64748b', group: 'architecture', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'chip', label: '算力', description: '计算模块图标', icon: 'mdi:memory', iconAsset: 'chip', color: '#0d9488', group: 'architecture', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  ...
  { id: 'paperIcon', label: '论文', description: '论文文档图标', icon: 'mdi:file-document-outline', iconAsset: 'paper', color: '#ea580c', group: 'paper', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'robotIcon', label: '模型', description: '智能模型图标', icon: 'mdi:robot-outline', iconAsset: 'robot', color: '#7c3aed', group: 'paper', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'notebookIcon', label: '笔记', description: '笔记图标', icon: 'mdi:notebook-outline', iconAsset: 'notebook', color: '#0f766e', group: 'paper', variant: 'icon', width: 42, height: 42, minWidth: 28, minHeight: 28 },
  { id: 'ideaIcon', label: '想法', description: '灵感图标', icon: 'mdi:lightbulb-outline', iconAsset: 'idea', color: '#f59e0b', group: 'paper', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'citationIcon', label: '引用', description: '引用图标', icon: 'mdi:format-quote-close', iconAsset: 'citation', color: '#2563eb', group: 'paper', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
  { id: 'labIcon', label: '实验', description: '实验图标', icon: 'mdi:flask-outline', iconAsset: 'lab', color: '#dc2626', group: 'paper', variant: 'icon', width: 40, height: 40, minWidth: 28, minHeight: 28 },
