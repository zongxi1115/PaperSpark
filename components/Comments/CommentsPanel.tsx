...
import { removeCommentThreadMarks, setCommentThreadResolved } from '@/lib/commentStyles'
...
export function CommentsPanel({
  ...
  const handleToggleResolved = useCallback((comment: EditorComment) => {
    ...
    setCommentThreadResolved(comment.id, !resolved)
    loadComments()
